	...
	if global.game_first_loading == true:
		if global.game_first_loading3 == true:
			if global.game_first_loading4 == true:
				...
				$dragon.position.x = global.dragon_start_posx
				$dragon.position.y = global.dragon_start_posy
			else:
				$player.position.x = global.player_exit_side_posx4
				$player.position.y = global.player_exit_side_posy4
				$dragon.position.x = global.dragon_exit_side_posx4
				$dragon.position.y = global.dragon_exit_side_posy4
			...
			if global.game_first_loading4 == true:
				...
				$dragon.position.x = global.dragon_exit_side_posx3
				$dragon.position.y = global.dragon_exit_side_posy3
		...
		if global.game_first_loading3 == true:
			if global.game_first_loading4 == true:
				...
				$dragon.position.x = global.dragon_exit_side_posx
				$dragon.position.y = global.dragon_exit_side_posy
			else:
				$player.position.x = global.player_exit_side_posx4
				$player.position.y = global.player_exit_side_posy4
				$dragon.position.x = global.dragon_exit_side_posx4
